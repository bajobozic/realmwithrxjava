...
public class TopRatedSearchTvShowsRealmProxy extends com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows
    implements RealmObjectProxy, TopRatedSearchTvShowsRealmProxyInterface {

    static final class TopRatedSearchTvShowsColumnInfo extends ColumnInfo
        ...
        TopRatedSearchTvShowsColumnInfo(String path, Table table) {
            final Map<String, Long> indicesMap = new HashMap<String, Long>(4);
            this.pageIndex = getValidColumnIndex(path, table, "TopRatedSearchTvShows", "page");
            indicesMap.put("page", this.pageIndex);
            this.resultsIndex = getValidColumnIndex(path, table, "TopRatedSearchTvShows", "results");
            indicesMap.put("results", this.resultsIndex);
            this.totalResultsIndex = getValidColumnIndex(path, table, "TopRatedSearchTvShows", "totalResults");
            indicesMap.put("totalResults", this.totalResultsIndex);
            this.totalPagesIndex = getValidColumnIndex(path, table, "TopRatedSearchTvShows", "totalPages");
        ...
        public final void copyColumnInfoFrom(ColumnInfo other) {
            final TopRatedSearchTvShowsColumnInfo otherInfo = (TopRatedSearchTvShowsColumnInfo) other;
        ...
        @Override
        public final TopRatedSearchTvShowsColumnInfo clone() {
            return (TopRatedSearchTvShowsColumnInfo) super.clone();
        }

    }
    private TopRatedSearchTvShowsColumnInfo columnInfo;
    private ProxyState<com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows> proxyState;
    ...
    TopRatedSearchTvShowsRealmProxy() {
        if (proxyState == null) {
            injectObjectContext();
        }
    ...
    private void injectObjectContext() {
        ...
        this.columnInfo = (TopRatedSearchTvShowsColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows>(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class, this);
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        if (!realmSchema.contains("TopRatedSearchTvShows")) {
            RealmObjectSchema realmObjectSchema = realmSchema.create("TopRatedSearchTvShows");
        ...
        return realmSchema.get("TopRatedSearchTvShows");
    }

    public static Table initTable(SharedRealm sharedRealm) {
        if (!sharedRealm.hasTable("class_TopRatedSearchTvShows")) {
            Table table = sharedRealm.getTable("class_TopRatedSearchTvShows");
        ...
        return sharedRealm.getTable("class_TopRatedSearchTvShows");
    }

    public static TopRatedSearchTvShowsColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_TopRatedSearchTvShows")) {
            Table table = sharedRealm.getTable("class_TopRatedSearchTvShows");
            ...
            final TopRatedSearchTvShowsColumnInfo columnInfo = new TopRatedSearchTvShowsColumnInfo(sharedRealm.getPath(), table);
            ...
            throw new RealmMigrationNeededException(sharedRealm.getPath(), "The 'TopRatedSearchTvShows' class is missing from the schema for this Realm.");
        }
    }

    public static String getTableName() {
        return "class_TopRatedSearchTvShows";
    }
    ...
    @SuppressWarnings("cast")
    public static com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows obj = null;
        if (update) {
            Table table = realm.getTable(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class);
            ...
            if (rowIndex != TableOrView.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class), false, Collections.<String> emptyList());
                    obj = new io.realm.TopRatedSearchTvShowsRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("page")) {
                if (json.isNull("page")) {
                    obj = (io.realm.TopRatedSearchTvShowsRealmProxy) realm.createObjectInternal(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.TopRatedSearchTvShowsRealmProxy) realm.createObjectInternal(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class, json.getInt("page"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("results")) {
            if (json.isNull("results")) {
                ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$results(null);
            } else {
                ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmGet$results().clear();
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmGet$results().add(item);
                }
            }
        }
        if (json.has("totalResults")) {
            if (json.isNull("totalResults")) {
                ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$totalResults(null);
            } else {
                ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$totalResults((int) json.getInt("totalResults"));
            }
        }
        if (json.has("totalPages")) {
            if (json.isNull("totalPages")) {
                ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$totalPages(null);
            } else {
                ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$totalPages((int) json.getInt("totalPages"));
            }
        }
        return obj;
    }
    ...
    public static com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows obj = new com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals("page")) {
                if (reader.peek() == JsonToken.NULL) {
                    reader.skipValue();
                    ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$page(null);
                } else {
                    ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$page((int) reader.nextInt());
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$results(new RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$totalResults((int) reader.nextInt());
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    ((TopRatedSearchTvShowsRealmProxyInterface) obj).realmSet$totalPages((int) reader.nextInt());
                }
            } else {
                reader.skipValue();
            }
    ...
    public static com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows copyOrUpdate(Realm realm, com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows) cachedRealmObject;
        } else {
            com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows realmObject = null;
            boolean canUpdate = update;
            if (canUpdate) {
                Table table = realm.getTable(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class);
                long pkColumnIndex = table.getPrimaryKey();
                Number value = ((TopRatedSearchTvShowsRealmProxyInterface) object).realmGet$page();
                long rowIndex = TableOrView.NO_MATCH;
                if (value == null) {
                    rowIndex = table.findFirstNull(pkColumnIndex);
                } else {
                ...
                if (rowIndex != TableOrView.NO_MATCH) {
                    try {
                        objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class), false, Collections.<String> emptyList());
                        realmObject = new io.realm.TopRatedSearchTvShowsRealmProxy();
    ...
    public static com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows copy(Realm realm, com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows realmObject = realm.createObjectInternal(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class, ((TopRatedSearchTvShowsRealmProxyInterface) newObject).realmGet$page(), false, Collections.<String>emptyList());
            cache.put(newObject, (RealmObjectProxy) realmObject);

            RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo> resultsList = ((TopRatedSearchTvShowsRealmProxyInterface) newObject).realmGet$results();
            if (resultsList != null) {
                RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo> resultsRealmList = ((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmGet$results();
            ...
            ((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmSet$totalResults(((TopRatedSearchTvShowsRealmProxyInterface) newObject).realmGet$totalResults());
            ((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmSet$totalPages(((TopRatedSearchTvShowsRealmProxyInterface) newObject).realmGet$totalPages());
            return realmObject;
        }
    }

    public static long insert(Realm realm, com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class);
        long tableNativePtr = table.getNativeTablePointer();
        TopRatedSearchTvShowsColumnInfo columnInfo = (TopRatedSearchTvShowsColumnInfo) realm.schema.getColumnInfo(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class);
        long pkColumnIndex = table.getPrimaryKey();
        Object primaryKeyValue = ((TopRatedSearchTvShowsRealmProxyInterface) object).realmGet$page();
        long rowIndex = TableOrView.NO_MATCH;
        if (primaryKeyValue == null) {
            rowIndex = Table.nativeFindFirstNull(tableNativePtr, pkColumnIndex);
        } else {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((TopRatedSearchTvShowsRealmProxyInterface) object).realmGet$page());
        }
        if (rowIndex == TableOrView.NO_MATCH) {
            rowIndex = table.addEmptyRowWithPrimaryKey(((TopRatedSearchTvShowsRealmProxyInterface) object).realmGet$page(), false);
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);

        RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo> resultsList = ((TopRatedSearchTvShowsRealmProxyInterface) object).realmGet$results();
        if (resultsList != null) {
        ...
        Number realmGet$totalResults = ((TopRatedSearchTvShowsRealmProxyInterface)object).realmGet$totalResults();
        ...
        Number realmGet$totalPages = ((TopRatedSearchTvShowsRealmProxyInterface)object).realmGet$totalPages();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        TopRatedSearchTvShowsColumnInfo columnInfo = (TopRatedSearchTvShowsColumnInfo) realm.schema.getColumnInfo(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class);
        long pkColumnIndex = table.getPrimaryKey();
        com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows object = null;
        while (objects.hasNext()) {
            object = (com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows.class);
    ...
    public static com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows createDetachedCopy(com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows)cachedObject.object;
            } else {
                unmanagedObject = (com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        }
        ((TopRatedSearchTvShowsRealmProxyInterface) unmanagedObject).realmSet$page(((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmGet$page());

        // Deep copy of results
        if (currentDepth == maxDepth) {
            ((TopRatedSearchTvShowsRealmProxyInterface) unmanagedObject).realmSet$results(null);
        } else {
            RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo> managedresultsList = ((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmGet$results();
            ...
            ((TopRatedSearchTvShowsRealmProxyInterface) unmanagedObject).realmSet$results(unmanagedresultsList);
        ...
        ((TopRatedSearchTvShowsRealmProxyInterface) unmanagedObject).realmSet$totalResults(((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmGet$totalResults());
        ((TopRatedSearchTvShowsRealmProxyInterface) unmanagedObject).realmSet$totalPages(((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmGet$totalPages());
        return unmanagedObject;
    }

    static com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows update(Realm realm, com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows realmObject, com.example.bajob.movieshatch.Pojo.TopRatedSearchTvShows newObject, Map<RealmModel, RealmObjectProxy> cache) {
        RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo> resultsList = ((TopRatedSearchTvShowsRealmProxyInterface) newObject).realmGet$results();
        RealmList<com.example.bajob.movieshatch.Pojo.TvShowInfo> resultsRealmList = ((TopRatedSearchTvShowsRealmProxyInterface) realmObject).realmGet$results();
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("TopRatedSearchTvShows = [");
    ...
    public boolean equals(Object o) {
        ...
        TopRatedSearchTvShowsRealmProxy aTopRatedSearchTvShows = (TopRatedSearchTvShowsRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aTopRatedSearchTvShows.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aTopRatedSearchTvShows.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aTopRatedSearchTvShows.proxyState.getRow$realm().getIndex()) return false;
